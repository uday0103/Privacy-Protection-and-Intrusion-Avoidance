...
<head>
<title>Health Care Center Profile</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Health Care Center Profile </h2>
          <p>&nbsp;</p>
		  ...
		  <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <tr>
              <td  width="145" height="40" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Email</strong></div></td>
            ...
            <tr>
              <td  width="145" height="40" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Mobile</strong></div></td>
              <td  width="164" valign="middle" height="40"><div align="left" class="style23 style9 style10 style6 style7" style="margin-left:20px;">
                  <%out.println(s3);%>
              </div></td>
            </tr>
            <tr>
              <td  width="145" height="40" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Address</strong></div></td>
            ...
            <tr>
              <td   width="145" height="51" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Date of Birth </strong></div                        ></td>
			...
			<tr>
              <td   width="145" height="51" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Gender</strong></div                        ></td>
              <td  width="164" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style7">
                  <div align="left" class="style23 style9 style10 style6" style="margin-left:20px;">
                    <%out.println(s6);%>
                  </div>
			...
			<tr>
              <td   width="145" height="51" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5" style="margin-left:20px;"><strong>Pincode</strong></div                        ></td>
              <td  width="164" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style7">
                  <div align="left" class="style23 style9 style10 style6" style="margin-left:20px;">
                    <%out.println(s7);%>
                  </div>
