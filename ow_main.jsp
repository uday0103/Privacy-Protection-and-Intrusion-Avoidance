...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to IOT Device Main : <span class="style3"><%=application.getAttribute("ow")%></span></h2>
		  
		  
		  
		  <p><img src="images/Architecture.jpg" width="618" height="269" /></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
