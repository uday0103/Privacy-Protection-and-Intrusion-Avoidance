                    ...
                    <TR>
                      <TD width="174" bgcolor="#FF0000"><div align="center" class="header style7 style8">
                        <div align="right" class="style12">
                          <div align="center">Enter keyword or Patient Name </div>
                        </div>
                      </div></TD>
...
try
{
               ...
               <p> 
               <div align="center" class="style11 style3"><strong>Patient Name : </strong><span class="style15"> <%=s2%></span></div>
               <span class="style3"><br />
               </span>
               <div align="center" class="style11 style3">Disease Name :  <span class="style15"> <%=decryptedValues3%></span></div>
               </p>
                <p>
