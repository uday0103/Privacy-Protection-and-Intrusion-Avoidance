...
<head>
<title>Health Care Center Reister</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">  Health Care Center Registration </h2>
		  ...
		  <form name="s" action="u_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top"> 
                  ...
                  <br />
                  Health Care Center Name (required)<br />
            </span></label>
                  <p class="style4">
                  ...
                  <label for="password">
				  <span class="style4">Password (required)<br />
                  </span></label>
                  <p class="style4">
