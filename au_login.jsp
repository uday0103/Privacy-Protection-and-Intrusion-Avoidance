...
<div class="main">
  ...
  <div class="content">
    ...
    <table border="0" width="57%" height="165">
      <tr>
        <td height="25" colspan="2" bgcolor="#FF0000"><img src="images/ALogin.jpg" width="275" height="107" /></td>
        </tr>
      <tr>
        <td width="48%" height="25" bgcolor="#FF0000"><span class="style4 style2 style3"><font size="5" face="Courier New, Courier, monospace"> Name</font> </span></td>
        <td width="52%" height="25" bgcolor="#FF0000"><input  name="userid" type="text" size="25" /></td>
      </tr>
      <tr>
        <td width="48%" height="25" bgcolor="#FF0000"><span class="style5 style2 style3"> <font size="5" face="Courier New, Courier, monospace">Pasword</font></span></td>
