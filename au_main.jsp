...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to KPS Main</h2>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="au_all_owners.jsp"><span>View All IOT Devices and Authorize</span></a></li>
            <li><a href="au_all_users.jsp"><span>View All Health Care Centers and Authorize</span></a></li>
