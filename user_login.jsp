...
<head>
<title>Health Care Center LogIn</title>
...
{
alert("Please Enter Health Care Center Name");
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1 style2">A Secure and Efficient Cloud Centric Internet of Medical Things Enabled <br />
             Smart Healthcare System with Public Verifiability </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style6">  Health Care Center Log In</h2>
    ...
    <p><span class="style6">New Health Care Center?</span>  <a href="u_register.jsp">click here to Register</a><br /> </p>
    <p>&nbsp;</p>
  <p> </p>
    </div>
</form>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style4">
            ...
            <li><a href="owner_login.jsp">IOT Device</a></li>
            <li><a href="user_login.jsp">Health Care Center</a></li>
            <li><a href="cs_login.jsp">Medical Cloud Servers</a></li>
            <li><a href="au_login.jsp">KPS</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
